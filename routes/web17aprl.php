...
Route::group(['middleware'=>['guest']], function (){
    ...
    Route::post('verify_mails',[RegisterController::class,'verify_mails']);

    Route::any('sendemail','Auth\RegisterController@sendmaild');
...
Route::group(['middleware'=>['auth']], function (){
 ...
 Route::post('apply-leave',[LeaveTypeController::class,'create']);
    ...
    Route::get('movetoemployee/{id}',[EmployeeController::class,'moveemplyee'])->name('movetoemployee');
	...
	Route::post('leaveaprove',[EmployeeLeaveController::class,'leaveaprove']);
	Route::post('leavedisaprove',[EmployeeLeaveController::class,'leavedisaprove']);
   

   Route::post('aplyleave',[EmployeeLeaveController::class,'aplyleave']);
