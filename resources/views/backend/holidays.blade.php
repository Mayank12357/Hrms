                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if(!$holiday->completed)
                                                <form action="{{route('completed',$holiday)}}" method="post">
                                                    @csrf
                                                    <button data-id="{{$holiday->id}}" class="dropdown-item btn mark_as_complete" type="submit"><i class="fa fa-star m-r-5"></i>Completed Holiday</button>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('holidays')}}" method="post">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="cal-icon"><input id="edit_date" class="form-control" name="comments" type="text"></div>
                                            </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Comments <span class="text-danger">*</span></label>
                        <div class="">
                        <input name="comments" class="form-control" type="text"></div>
                    </div>
