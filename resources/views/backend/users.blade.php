							...
							<div class="dropdown dropdown-action">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a data-id="{{$user->id}}" class="dropdown-item deletebtn" href="javascript:void(0)" data-toggle="modal"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                       ...
                                       <a data-id="{{$user->id}}" class="dropdown-item" href="/movetoemployee/{{$user->id}}"><i class="fa fa-arrows-alt m-r-5"></i>Move To Employee</a>
...
$(document).on("click", ".movelink", function(){
