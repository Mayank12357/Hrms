			...
			<div class="modal-body">
				<form method="post" action="{{route('jobs')}}">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Desginantion</label>
								<select class="select" name="department" required>
									@if(!empty($desginatios))
										@foreach ($desginatios as $desginatio)
											<option value="{{$desginatio->id}}">{{$desginatio->name}}</option>
										@endforeach
									@endif
								</select>
							</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" name="vacancies" type="number" min="1">
							</div>
						</div>
					</div>
