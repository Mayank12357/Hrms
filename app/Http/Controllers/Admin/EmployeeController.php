...
class EmployeeController extends Controller
{
  ...
  public function moveemplyee(Request $request, $id)
    {
      $title="employees";

 User::where('id', $id)->update(['is_emp' => 1]);

$userecord = User::where('id', $id)->first();
       ...
       Employee::create([
            'uuid' =>$uuid,
            'user_id' => $userecord->id,
            'firstname'=>$userecord->name,
...
$employees = Employee::with('department','designation')->get();
        ...
        return view("backend.employees", compact('employees','title'));
    }
